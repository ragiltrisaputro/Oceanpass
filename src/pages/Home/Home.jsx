...
export default function Home() {
    return(
        ...
        <Header/>
        <div>
        <img src={Coverbg} alt="imgage-bg" className="xl:h-screen xl:w-full h-[90vh] fixed bg-repeat bg-center bg-contain "/>
        ...
        <p className="relative font-inter italic top-[-15px] pl-24 xl:pl-44 text-white font-bold xl:text-[25px] text-[16px]">Indahnya Pelabuhan</p>
        <p className="relative font-inter italic top-[-15px] xl:text-[48px] text-white text-[20px] font-bold px-6">PEMBELIAN TIKET CEPAT</p>
        <p className="relative font-inter italic top-[-15px] xl:text-[48px] text-white text-[20px] font-bold px-6">DAN TERPERCAYA</p>
        ...
        <div className="relative top-[-50px] xl:top-[13.5rem]">
        <p className="text-white px-8">Hubungi Kami :</p>
