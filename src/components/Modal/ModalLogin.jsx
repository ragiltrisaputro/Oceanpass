import { ImgMasuk } from '../../assets/img/Modal/masuk';
        ...
        <div>
            <div className={`fixed top-0 left-0 w-full h-full flex items-center justify-center z-[40000] ${open ? 'block' : 'hidden'}`}>
                ...
                <div className={`bg-white  rounded-3xl shadow-lg z-50 overflow-hidden flex`}>
                    <div className="w-1/2">
                        <img src={ImgMasuk} alt="Login" className=" hidden md:block max-w-full h-auto" />
                    </div>
                    <div className="w-full xl:w-1/2 p-6">
                        ...
                        <p className="font-bold text-[#154C79] text-[24px]">MASUK</p>
                        </div>
                    <div className="flex items-center justify-center">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="flex items-center justify-center">
                                <button onClick={handleClick} type="submit" className="p-2 bg-[#154C79] w-36 rounded-md text-white cursor-pointer font-bold text-xl hover:bg-[#154C79] hover:opacity-80">MASUK</button>
                            </div>
                        </form>
                        </div>
                    </div>
